...
//       setErrors(validationErrors);
//       setLoading(false);
//       setDisable(false); // Re-enable the button if there are errors
...
//       setDisable(false); // Enable the button after submission
//     }
//   };
...
//             </label>
//             <input
//               type="tel" // Changed to "tel" for better representation
//               id="phone"
//               onChange={(e) => setPhone(e.target.value)}
//               value={phone}
//               name="phone"
...
//             disabled={disable}
//             className={`text-white  bg-gray-700 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg ${
//               loading ? "opacity-50" : ""
//             }`}
//           >
...
//             onClick={notification}
//             disabled={loading}
//             className="text-white disabled:bg-gray-600 disabled:cursor-not-allowed bg-black border-0 py-2 px-8 focus:outline-none hover:bg-gray-800 rounded text-lg"
//           >
//             {loading ? "Submitting..." : "Submit"}
//           </button>
//         </div>
