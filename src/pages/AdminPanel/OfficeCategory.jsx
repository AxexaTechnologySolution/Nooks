...
const OfficeCategory = () => {
  ...
  const handleDelete = async (productId, imageUrl) => {
    ...
    try {
      // Parse the storage path from the image URL
    ...
    <div className='container max-w-4xl bg-white p-8 rounded-lg shadow-lg'>
      ...
      <div className="flex flex-col space-y-10">
        ...
        <button
          ...
          className={`bg-green-600 text-white p-3 rounded-lg flex items-center justify-center shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 ${
