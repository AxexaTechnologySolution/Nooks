    ...
    <div className='min-h-screen bg-gray-100 flex flex-col items-center pt-10'>
      ...
      <div className='container max-w-4xl bg-white p-8 rounded-lg shadow-lg'>
                ...
                <div key={image.id} className="flex flex-col items-center mb-4 border p-2">
                  <div className='flex md:flex-col items-center '>
                    <div className='items-center text-center'>
                      <div className="font-semibold mb-5">{image.categoryName}</div>
        ...
        <div className='mt-10 space-x-3 flex justify-center md:justify-start'>
          <Link to={"/admin"}><button className='px-5 py-1 border rounded-lg hover:bg-green-700 bg-green-600 text-white'>Previous</button></Link>
          <Link to={"/ip-images"}><button className='px-5 py-1 border rounded-lg hover:bg-green-700 bg-green-600 text-white'>Next</button></Link>
        </div>
      </div>
    </div>
  );
